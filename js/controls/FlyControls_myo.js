...
THREE.FlyControls = function ( object, domElement ) {
	...
	var initMyo = function() {
      ...
      function switchAxis() {
          if (current_axis=='y')
{              self.moveState.yawLeft = self.moveState.pitchDown;
            	self.moveState.pitchDown = 0

              self.moveState.yawRight = self.moveState.pitchUp;
...
{              self.moveState.pitchDown = self.moveState.yawLeft;
      ...
      function stopMotion() {
        	self.moveState = { up: 0, down: 0, left: 0, right: 0, forward: 0, back: 0, pitchUp: 0, pitchDown: 0, yawLeft: 0, yawRight: 0, rollLeft: 0, rollRight: 0 };
      }
